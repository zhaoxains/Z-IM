        ...
        child: ListView(
          ...
          children: [
            ...
            InsetSection(
              ...
              children: const [
                InsetTile(
                  leading: _FeatureIcon(icon: CupertinoIcons.creditcard_fill, color: Color(0xFF5B8FF9)),
                  title: '钱包',
                  subtitle: '余额、充值、支付方式',
                ),
                InsetTile(
                  leading: _FeatureIcon(icon: CupertinoIcons.money_dollar_circle_fill, color: Color(0xFFF6BD16)),
                  title: '余额明细',
            ...
            InsetSection(
              ...
              children: const [
                InsetTile(
                  leading: _FeatureIcon(icon: CupertinoIcons.gift_fill, color: Color(0xFFE8684A)),
                  title: '发红包',
                  subtitle: '单聊红包、群红包、拼手气红包',
                ),
                InsetTile(
                  leading: _FeatureIcon(icon: CupertinoIcons.doc_text_fill, color: Color(0xFF9270CA)),
                  title: '红包记录',
